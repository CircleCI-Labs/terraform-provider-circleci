...
## Support status of this repository

This repository is part of CircleCI Labs. It is **not** covered by CircleCI support, and a
vulnerability report about *this provider* is handled on a best-effort basis by field
engineering rather than under any support SLA. A vulnerability in the **CircleCI API or
platform** is a different matter and goes through the channels above, which are staffed.
